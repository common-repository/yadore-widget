...
<form method="post" class="yw-search-form">
	<div class="row g-4">
		<div class="col">
			<input type="search" name="keyword" class="form-control" placeholder="<?php echo esc_attr( $placeholder ) ?>"/>
		</div>
		<div class="col-auto">
		...
		<div class="col-auto">
			<button type="submit" class="btn btn-primary"><?php echo esc_html( $submit ) ?></button>
		</div>
	</div>
